...
<?php if ($success == true) {
  echo '<h1>votre inscription a bien été prise en compte ! </h1>';
}
else { ?>
  <form id="forminscrit" action="" method="post" novalidate>
  <div class="form1">
    <label for="name">Nom* </label>
    <input type="text" name="nom"  id="name" value="<?php if (!empty($_POST['nom'])){echo $_POST['nom'];} ?>">
  ...
  <div class="form1">
    ...
    <input type="email" name="email"  id="mail" value="<?php if (!empty($_POST['email'])){echo $_POST['email'];} ?>">
